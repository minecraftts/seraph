...
export default class Keyboard extends (EventEmitter as new () => TypedEventEmitter<KeyboardEvents>) {
    ...
    public static KeyMods = class KeyMods {
        public static SHIFT: typeof GLFW_MOD_SHIFT = GLFW_MOD_SHIFT;
        public static CONTROL: typeof GLFW_MOD_CONTROL = GLFW_MOD_CONTROL;
        public static ALT: typeof GLFW_MOD_ALT = GLFW_MOD_ALT;
        public static SUPER: typeof GLFW_MOD_SUPER = GLFW_MOD_SUPER;
        public static CAPS_LOCK: typeof GLFW_MOD_CAPS_LOCK = GLFW_MOD_CAPS_LOCK;
        public static NUM_LOCK: typeof GLFW_MOD_NUM_LOCK = GLFW_MOD_NUM_LOCK;
    };
}